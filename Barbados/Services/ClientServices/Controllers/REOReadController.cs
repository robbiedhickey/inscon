namespace Enterprise.ApplicationServices.ClientServices.Controllers
{
    using System;
    ...
    using Enterprise.DALServices.ViewModelMapper;

    public class REOReadController : ApiController
    {
        [HttpGet]
        public REOPropertyInfo GetReoPropertyInfo(int organizationID, string loanNumber)
        {
            ...
            retValue = mapper.Map(organizationID, loanNumber);

            return retValue;
        }

        private REOPropertyInfo Load(int organizationID, string loanNumber)
        {
            REOPropertyInfo retValue = new REOPropertyInfo();
            
            AssetInfo assetInfo = new AssetInfo();
            assetInfo.Client = "Chase REO";
