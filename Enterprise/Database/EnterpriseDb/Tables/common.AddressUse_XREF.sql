...
GO
ALTER TABLE [common].[AddressUse_XREF] ADD CONSTRAINT [FK_AddressUse_XREF_Address] FOREIGN KEY ([AddressID]) REFERENCES [common].[Address] ([AddressID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
