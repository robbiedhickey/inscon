...
GO
ALTER TABLE [generic].[AddressUse] ADD CONSTRAINT [FK_AddressUse_Address1] FOREIGN KEY ([AddressID]) REFERENCES [generic].[Address] ([AddressID]) ON DELETE CASCADE ON UPDATE CASCADE
GO
