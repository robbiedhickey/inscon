...
namespace LLBL.DAL.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the People entity</summary>
		public EntityQuery<PeopleEntity> People
		{
			get { return Create<PeopleEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the TestPeople entity</summary>
		public EntityQuery<TestPeopleEntity> TestPeople
		{
			get { return Create<TestPeopleEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the TestPeople1 entity</summary>
		public EntityQuery<TestPeople1Entity> TestPeople1
		{
			get { return Create<TestPeople1Entity>(); }
		}
