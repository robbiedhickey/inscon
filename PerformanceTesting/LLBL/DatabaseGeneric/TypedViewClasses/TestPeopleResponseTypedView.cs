...
namespace LLBL.DAL.TypedViewClasses
{
	...
	/// <summary>Typed datatable for the view 'TestPeopleResponse'.<br/><br/></summary>
	[Serializable, System.ComponentModel.DesignerCategory("Code")]
	[ToolboxItem(true)]
	[DesignTimeVisible(true)]
	public partial class TestPeopleResponseTypedView : TypedViewBase<TestPeopleResponseRow>, ITypedView2
			...
			
	{
		...
		static TestPeopleResponseTypedView()
		{
			SetupCustomPropertyHashtables();
		}

		/// <summary>CTor</summary>
		public TestPeopleResponseTypedView():base("TestPeopleResponse")
		{
			InitClass();
		}
#if !CF	
		...
		protected TestPeopleResponseTypedView(SerializationInfo info, StreamingContext context):base(info, context)
		{
		...
		{
			return new TestPeopleResponseRow(rowBuilder);
		}
		...
		protected override void InitClass()
		{
			...
			_fields = EntityFieldsFactory.CreateTypedViewEntityFieldsObject(TypedViewType.TestPeopleResponseTypedView);
		...
		{
			TestPeopleResponseTypedView cloneToReturn = ((TestPeopleResponseTypedView)(base.Clone()));
		...
		{
			return new TestPeopleResponseTypedView();
		}
#endif
		...
		{
			get { return TestPeopleResponseTypedView.CustomProperties;}
		}
		...
		{
			get { return TestPeopleResponseTypedView.FieldsCustomProperties;}
		}
	...
	/// <summary>Typed datarow for the typed datatable TestPeopleResponse</summary>
	public partial class TestPeopleResponseRow : DataRow
		// __LLBLGENPRO_USER_CODE_REGION_START AdditionalInterfacesRow
		// __LLBLGENPRO_USER_CODE_REGION_END
			
	{
		#region Class Member Declarations
		private TestPeopleResponseTypedView	_parent;
		#endregion

		/// <summary>CTor</summary>
		/// <param name="rowBuilder">Row builder object to use when building this row</param>
		protected internal TestPeopleResponseRow(DataRowBuilder rowBuilder) : base(rowBuilder) 
		{
			_parent = ((TestPeopleResponseTypedView)(this.Table));
		}
